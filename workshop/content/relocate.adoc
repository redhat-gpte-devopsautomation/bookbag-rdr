...
[NOTE] For production environment or real life scenario, the applications routes will be updated in Global Load Balancer using automated way for e.g. using ansible to update GLB's with the new updated routes post failover / relocate.
