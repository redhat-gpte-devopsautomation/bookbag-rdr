...
Use the sample app example from https://github.com/RamenDR/ocm-ramen-samples to create a deployment in busybox-test namespace for failover and failback testing.
...
Lets puts this learning to action now and configure a sample application for DR. Use the above steps to setup busybox applicaiton in a new namespace called busybox-test
