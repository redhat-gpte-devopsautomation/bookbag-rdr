...
* Test failover and reolcate operations using the sampole appklication between managed clusters.

=== Review the implementation

Logon to the Hub Cluster ACM console using your OpenShift credentials.

First, find the *Route* that has been created for the ACM console on the hub cluster:
