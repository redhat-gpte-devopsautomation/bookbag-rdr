...
[arabic]
. Go to the 
 link:{hub_openshift_cluster_console_url}[OpenShift console for Hub Cluster^] 
 and log in with your credentials username: {hub_openshift_cluster_admin_username} 
 and password: {hub_openshift_cluster_admin_password}.
