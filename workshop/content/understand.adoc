...
[NOTE]
Since this is lab environment the api connection is insecured. Please accept the same in your lab when prompted. For production scenarios the api connection is expected to be secured.
