...
In the hands on lab participant will understand the nuances of how to setup an application to continue working during disaster recovery. We will use a real life e-retailer application for a fictitious company called Globex selling goods online. Learn how to Deploy and setup this application for business continuity. 
...
Finally, we onboard a sample application to be part of Disaster Recovery strategy and test failover/relocate.This time without any guided information and test your understanding. 
...
The lab is divided into 5 main sections (expecting 15 minutes per section):
