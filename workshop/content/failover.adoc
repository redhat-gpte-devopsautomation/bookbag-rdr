...
[arabic]
. Open a terminal, login to the primary cluster link:{primary_openshift_cluster_console_url}[Primary Cluster OpenShift Console Login] with your credentials username: {primary_openshift_cluster_admin_username} and password: {primary_openshift_cluster_admin_password}.
+
